const CACHE_NAME='shiny-home-v89';
const DATA_CACHE='shiny-home-data-stable-v2';
const APP_SHELL=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
const NAME_ASSETS=[
 'https://raw.githubusercontent.com/sindresorhus/pokemon/main/data/ja.json',
...
self.addEventListener('fetch',e=>{
 ...
 if(NAME_ASSETS.some(u=>req.url===u)||req.url.includes('/sindresorhus/pokemon')||req.url.includes('/pokemon@3.3.0/data/')){
